...
async function run() {
  ...
  const text = fs.readFileSync(path.join(__dirname, '../scratch/new_test_questions_1_12.txt'), 'utf-8');
  ...
  console.log(`Found ${mcqsToInsert.length} test questions for Topics 1-12.`);
  ...
  console.log('\nDone updating test questions Topics 1-12!');
}
