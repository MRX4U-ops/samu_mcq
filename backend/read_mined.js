...
const path = 'c:\\samu_mcq\\mobile-app\\src\\data\\mined_questions.json';
if (!fs.existsSync(path)) {
  console.log('mined_questions.json does not exist');
  process.exit(1);
}

const data = JSON.parse(fs.readFileSync(path, 'utf8'));
console.log('Keys in mined_questions:', Object.keys(data));
