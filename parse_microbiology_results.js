...
const rawText = fs.readFileSync('c:/samu_mcq/clipboard_utf8.txt', 'utf8');
...
fs.writeFileSync('c:/samu_mcq/mobile-app/src/data/microbiology_results.json', JSON.stringify(results, null, 2));
