...
blocks.forEach((block, index) => {
  ...
  // The rest are options. We need to clean up the `**\*` markers
...
function updateFile(filePath) {
  ...
  // A regex to find the exported object
  ...
  let obj;
  try {
    // We use eval carefully since this is a local JS file containing an object literal
    obj = eval('(' + objText + ')');
  } catch (e) {
