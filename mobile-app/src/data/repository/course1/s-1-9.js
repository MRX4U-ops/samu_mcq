export const s_1_9 = {
  ...
  "t-s-1-9-14": [
    {
      "question": "1.\tWhat are 5-membered heterocyclic compounds primarily used for in medicine?",
      "options": [
        "They serve as active pharmaceutical ingredients",
    ...
    {
      "question": "2.\tWhich of the following is an example of a 5-membered heterocyclic compound used in medicine?",
      "options": [
        "Imidazole",
        "Acetone",
        "Water",
    ...
    {
      "question": "3.\tHow do 5-membered heterocyclic compounds function in neuromodulation?",
      "options": [
    ...
    {
      "question": "4.\tWhich 5-membered heterocyclic compound is used in the treatment of fungal infections?",
      "options": [
        "Fluconazole",
        "Sodium chloride",
        "Glucose",
    ...
    {
      "question": "5.\t5-membered heterocyclic compounds can act as:",
      "options": [
    ...
    {
      "question": "6.\tWhat role do heterocyclic compounds play in designing neuroactive drugs?",
      "options": [
    ...
    {
      "question": "7.\tWhich of the following is an example of a neuromodulator containing a 5-membered heterocycle?",
      "options": [
        "Histamine",
        "Glucose",
        "Insulin",
    ...
    {
      "question": "8.\t5-membered heterocyclic compounds are important because:",
      "options": [
    ...
    {
      "question": "9.\tWhich 5-membered heterocyclic compound has anti-inflammatory properties?",
      "options": [
        "Caffeine",
        "Methanol",
        "Chlorine",
    ...
    {
      "question": "10.\tHow do 5-membered heterocyclic compounds affect the central nervous system?",
      "options": [
    ...
    {
      "question": "11.\t5-membered heterocyclic compounds can be classified as:",
      "options": [
        "Therapeutic agents",
    ...
    {
      "question": "12.\tWhich of the following is a therapeutic application of 5-membered heterocyclic compounds?",
      "options": [
    ...
    {
      "question": "13.\tWhat is a primary characteristic of condensed heterocyclic compounds?",
      "options": [
    ...
    {
      "question": "14.\tWhat is the function of heterocyclic neuromodulators?",
      "options": [
    ...
    {
      "question": "15.\tCondensed heterocyclic compounds are often used in medicine to:",
      "options": [
    ...
    {
      "question": "16.\tHow do condensed heterocyclic compounds contribute to drug efficacy?",
      "options": [
    ...
    {
      "question": "17.\tWhich 5-membered heterocyclic compound is used as an antidepressant?",
      "options": [
        "Fluoxetine",
        "Sodium chloride",
        "Glucose",
    ...
    {
      "question": "18.\tCondensed heterocyclic compounds are typically used in:",
      "options": [
    ...
    {
      "question": "19.\tWhat is a key characteristic of heterocyclic compounds in terms of drug design?",
      "options": [
    ...
    {
      "question": "20.\tWhich of the following is a 5-membered heterocyclic compound used in treating parasitic infections?",
      "options": [
        "Albendazole",
        "Caffeine",
        "Glucose",
    ...
    {
      "question": "21.\tHow do condensed heterocyclic compounds work as neuroprotective agents?",
      "options": [
    ...
    {
      "question": "22.\tWhat is the role of 5-membered heterocyclic compounds in antifungal treatments?",
      "options": [
    ...
    {
      "question": "23.\t5-membered heterocyclic compounds can act as:",
      "options": [
    ...
    {
      "question": "24.\tWhich of the following is an example of a neuromodulator with a 5-membered heterocycle?",
      "options": [
        "Serotonin",
        "Chlorine",
        "Glucose",
    ...
    {
      "question": "25.\tHow are 5-membered heterocyclic compounds metabolized in the body?",
      "options": [
  ...
  "t-s-1-9-15": [
    {
      "question": "1.\tWhat are 6-membered heterocyclic compounds used for in medicine?",
      "options": [
    ...
    {
      "question": "2.\tWhich of the following is an example of a 6-membered heterocyclic compound used as a medicinal agent?",
      "options": [
        "Pyrimidine",
        "Acetone",
        "Sodium chloride",
    ...
    {
      "question": "3.\tHow do 6-membered heterocyclic compounds function in the body?",
      "options": [
    ...
    {
      "question": "4.\tWhich 6-membered heterocyclic compound is used in cancer treatment?",
      "options": [
        "Methotrexate",
        "Caffeine",
        "Vitamin D",
    ...
    {
      "question": "5.\tWhat is the role of 6-membered heterocyclic compounds in neurology?",
      "options": [
    ...
    {
      "question": "6.\tWhich of the following is an example of a 6-membered heterocyclic compound involved in brain function?",
      "options": [
        "Pyridoxine",
        "Chlorine",
        "Sodium bicarbonate",
    ...
    {
      "question": "7.\t6-membered heterocyclic compounds can act as:",
      "options": [
    ...
    {
      "question": "8.\tWhich 6-membered heterocyclic compound is used to treat bacterial infections?",
      "options": [
        "Chloramphenicol",
        "Sodium chloride",
        "Acetone",
    ...
    {
      "question": "9.\tHow do 6-membered heterocyclic compounds function in drug design?",
      "options": [
    ...
    {
      "question": "10.\t6-membered heterocyclic compounds are important in the development of:",
      "options": [
    ...
    {
      "question": "11.\tWhich of the following is a 6-membered heterocyclic compound used in pain management?",
      "options": [
        "Codeine",
        "Caffeine",
        "Chlorine",
    ...
    {
      "question": "12.\tWhat is a common feature of 6-membered heterocyclic compounds used in drug therapies?",
      "options": [
    ...
    {
      "question": "13.\tWhat is the mechanism of action for 6-membered heterocyclic compounds in treating infections?",
      "options": [
    ...
    {
      "question": "14.\tWhich 6-membered heterocyclic compound is used in the treatment of malaria?",
      "options": [
        "Chloroquine",
        "Acetaminophen",
        "Vitamin C",
    ...
    {
      "question": "15.\tWhat is the significance of 6-membered heterocyclic compounds in medicine?",
      "options": [
    ...
    {
      "question": "16.\tHow do 6-membered heterocyclic compounds contribute to drug efficacy?",
      "options": [
    ...
    {
      "question": "17.\tWhich 6-membered heterocyclic compound is commonly used as an antidepressant?",
      "options": [
        "Fluoxetine",
        "Chlorine",
        "Caffeine",
    ...
    {
      "question": "18.\t6-membered heterocyclic compounds are used to treat:",
      "options": [
    ...
    {
      "question": "19.\tHow do 6-membered heterocyclic compounds affect neurotransmitter systems?",
      "options": [
    ...
    {
      "question": "20.\tWhich 6-membered heterocyclic compound is used in immunosuppressive therapy?",
      "options": [
        "Azathioprine",
        "Sodium chloride",
        "Caffeine",
    ...
    {
      "question": "21.\tWhich of the following is a role of 6-membered heterocyclic compounds in drug delivery?",
      "options": [
    ...
    {
      "question": "22.\tHow do 6-membered heterocyclic compounds serve as neuromodulators?",
      "options": [
    ...
    {
      "question": "23.\tWhat is the application of 6-membered heterocyclic compounds in anti-inflammatory drugs?",
      "options": [
    ...
    {
      "question": "24.\t6-membered heterocyclic compounds are often involved in the synthesis of:",
      "options": [
    ...
    {
      "question": "25.\tWhat makes 6-membered heterocyclic compounds effective in medicine?",
      "options": [
  ...
  "t-s-1-9-17": [
    {
      "question": "1.\tWhat are proteins primarily responsible for in the body?",
      "options": [
    ...
    {
      "question": "2.\tWhich of the following is an important function of proteins in medicine?",
      "options": [
    ...
    {
      "question": "3.\tHow do proteins contribute to cellular functions?",
      "options": [
    ...
    {
      "question": "4.\tWhat is the primary structure of proteins?",
      "options": [
    ...
    {
      "question": "5.\tWhich of the following is an example of a protein involved in immune response?",
      "options": [
        "Antibodies",
        "Sodium chloride",
        "Chlorine",
    ...
    {
      "question": "6.\tHow do proteins contribute to muscle function?",
      "options": [
    ...
    {
      "question": "7.\tWhat is the role of proteins in enzyme catalysis?",
      "options": [
    ...
    {
      "question": "8.\tWhich of the following proteins is critical for blood clotting?",
      "options": [
        "Fibrinogen",
        "Caffeine",
        "Glucose",
    ...
    {
      "question": "9.\tProteins are important for:",
      "options": [
    ...
    {
      "question": "10.\tWhich protein is essential for the transport of oxygen in the blood?",
      "options": [
        "Hemoglobin",
        "Chlorine",
        "Caffeine",
    ...
    {
      "question": "11.\tHow are proteins used in medicine to treat diseases?",
      "options": [
    ...
    {
      "question": "12.\tWhich of the following is a function of proteins in blood circulation?",
      "options": [
    ...
    {
      "question": "13.\tProteins can be used therapeutically to:",
      "options": [
    ...
    {
      "question": "14.\tHow do proteins affect drug efficacy?",
      "options": [
    ...
    {
      "question": "15.\tWhich protein is involved in oxygen transport in muscles?",
      "options": [
        "Myoglobin",
        "Caffeine",
        "Chlorine",
    ...
    {
      "question": "16.\tProteins play an essential role in:",
      "options": [
    ...
    {
      "question": "17.\tWhich of the following reactions are specific to proteins?",
      "options": [
    ...
    {
      "question": "18.\tWhat is the role of proteins in cellular communication?",
      "options": [
    ...
    {
      "question": "19.\tWhich of the following is a function of proteins in the nervous system?",
      "options": [
    ...
    {
      "question": "20.\tProteins contribute to cell structure by:",
      "options": [
    ...
    {
      "question": "21.\tWhich protein is involved in the immune response to infections?",
      "options": [
        "Antibodies",
        "Glucose",
        "Caffeine",
    ...
    {
      "question": "22.\tHow do proteins act in the healing of wounds?",
      "options": [
    ...
    {
      "question": "23.\tProteins are essential for the function of:",
      "options": [
    ...
    {
      "question": "24.\tHow do proteins regulate metabolic processes in the body?",
      "options": [
    ...
    {
      "question": "25.\tWhich protein is involved in the response to cellular stress?",
      "options": [
        "Heat shock proteins",
        "Caffeine",
        "Sodium chloride",
