export const s_1_9 = {
  "t-s-1-9-0": {
    ...
    "situational": [
      {
        "question": "Situation: A patient visited a doctor with hypokalemia (potassium deficiency). How does the potassium deficiency in this patient affect the biological significance of S-elements in the body?",
        "options": [
          "*Disruption of cellular electrolyte balance",
          "Increase in immunity",
          "Decrease in vitamin assimilation",
          "Acceleration of protein synthesis"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: A patient was diagnosed with hyponatremia (sodium deficiency). Which process will this lead to a disruption in?",
        "options": [
          "*Water-electrolyte balance and nerve impulse transmission",
      ...
      {
        "question": "Situation: People use fluoride toothpaste to strengthen teeth. What role does fluoride play in the body?",
        "options": [
      ...
      {
        "question": "Situation: The doctor recommended calcium supplements for the patient. Which key process in the body requires calcium?",
        "options": [
          "*Maintaining water-electrolyte balance",
          "Neurotransmitter production",
          "Hormonal regulation",
          "Blood clotting and bone tissue formation"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: Which S-element decreases the effectiveness of hemoglobin, the oxygen-carrying molecule in the body?",
        "options": [
          "*Iron deficiency causes disruption of oxygen transport",
          "Silicon increases concentration its effectiveness",
          "Phosphorus deficiency increases oxygen transport",
          "Iodine reduces its effectiveness"
        ],
        "correctIndex": 0
      }
    ]
  ...
  "t-s-1-9-1": {
    "test": [
      ...
      {
        "question": "What type(s) of biological elements sodium does represent?",
        "options": [
          "*Essential",
          "Organogenic, Essential",
          "Inorganic",
    ...
    "situational": [
      {
        "question": "Situation: If salt is added to boiling water, how does the boiling point change?",
        "options": [
          "*Boiling point increases",
          "Boiling point decreases",
          "No change occurs",
          "Boiling process accelerates"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: What factors does the osmometric pressure of a solution depend on?",
        "options": [
          "*The number of particles in the solution",
          "The temperature and pH value of the solution",
          "The concentration and color of the solution",
          "The volume of the solution"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: What happens to the properties of a solution when acid is added to boiling water?",
        "options": [
      ...
      {
        "question": "Situation: What happens when a hypotonic solution is introduced into the body?",
        "options": [
          "*Cells may swell and burst",
          "Cells",
          "Water is expelled from cells",
          "Cells shrink and decrease in size"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: What is the purpose of isotonic solutions in medicine?",
        "options": [
          "*To maintain blood volume",
          "To control cholesterol levels",
          "To stimulate neurotransmitter production",
  ...
  "t-s-1-9-2": {
    "test": [
      ...
      },
      {
        ...
        "options": [
          "*Molar mass of solutions",
          "Shape of solute molecules",
          "Atomic mass of solutions",
          "Color of solutions"
        ],
        "correctIndex": 0
      },
    ...
    "situational": [
      {
        "question": "Situation: A patient complained of increased gastric acidity. What method will be used to prepare medicine to address this issue?",
        "options": [
      ...
      {
        "question": "Situation: The doctor used the acidimetry method to determine the acid levels in the patient's blood. How does this method work?",
        "options": [
      ...
      {
        "question": "Situation: When phenolphthalein is used as an indicator in titrimetric analysis, when does the solution change color?",
        "options": [
      ...
      {
        "question": "Situation: Which alkalimetric substance is used to reduce the amount of gastric acid?",
        "options": [
          "*Sodium bicarbonate",
          "Glucose solution",
          "Hydrochloric acid",
      ...
      {
        "question": "Situation: Which substance is used as an indicator during the acidimetry process?",
        "options": [
          "*Methyl orange",
          "Ether",
          "Salt solution",
  ...
  "t-s-1-9-3": {
    "test": [
      ...
      {
        "question": "In a titration, the analyte is:",
        "options": [
      ...
      {
        "question": "The point at which the reaction is complete is called the:",
        "options": [
          "*Equivalence point",
          "Buffer point",
          "Starting point",
      ...
      {
        "question": "The substance that changes color at the equivalence point is called:",
        "options": [
          "*Indicator",
          "Titrant",
          "Buffer",
      ...
      {
        "question": "The volume of titrant added to reach the equivalence point is measured using a:",
        "options": [
          "*Burette",
          "Pipette",
          "Flask",
      ...
      {
        "question": "What is the pH at the equivalence point in a strong acid-strong base titration?",
        "options": [
          "*7",
          "Less than 7",
          "Greater than 7",
      ...
      {
        "question": "What is the purpose of titration?",
        "options": [
      ...
      {
        "question": "What is the shape of the titration curve for a strong acid and strong base titration?",
        "options": [
          "*S-shaped",
          "Straight line",
          "Parabolic",
      ...
      {
        "question": "What is the solution of known concentration called in a titration?",
        "options": [
          "*Standard solution",
          "Unknown solution",
          "Neutral solution",
      ...
      {
        "question": "Which indicator is commonly used for acid-base titrations?",
        "options": [
          "*Phenolphthalein",
      ...
      {
        "question": "Which piece of equipment is used to deliver the titrant in a titration?",
        "options": [
          "*Burette",
          "Funnel",
          "Pipette",
      ...
      {
        "question": "Which type of reaction is most commonly used in titration?",
        "options": [
          "*Neutralization",
          "Decomposition",
          "Combustion",
    ...
    "situational": [
      {
        "question": "Situation: How does the color of the solution change when potassium permanganate is used?",
        "options": [
      ...
      {
        "question": "Situation: How is the oxidation state measured in oxidimetric analysis?",
        "options": [
          "*By the amount of reagent used",
          "By measuring osmotic pressure",
          "By the color change of the solution",
          "By determining the amount of electrolytes"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: What is the primary application of the permanganometric method?",
        "options": [
          "*Determining the amount of organic substances in blood and fluids",
          "Assessing ion activity",
      ...
      {
        "question": "Situation: Which analysis method uses potassium permanganate as a strong oxidizer?",
        "options": [
          "*Permanganometry",
          "Iodometry",
      ...
      {
        "question": "Situation: Which substance is measured in the body using iodometric analysis?",
        "options": [
          "*Acids and bases",
          "Vitamin C",
          "Carbonate compounds",
  ...
  "t-s-1-9-4": {
    ...
    "situational": [
      {
        "question": "Situation: A doctor recommended using radioactive iodine to examine the thyroid gland in a patient. What principle does this method rely on ?",
        "options": [
          "*Emission of alpha particles",
          "Imaging through gamma radiation",
          "Neutron activation analysis",
          "Reaction with beta particles"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: In nuclear tomography (PET), a radiopharmaceutical was administered to the patient. What particles are detected by the detector in this method?",
        "options": [
          "*Alpha particles",
          "Neutrons",
      ...
      {
        "question": "Situation: What advantage do medical instruments have?",
        "options": [
          "*Only kills microorganisms",
          "Sterilizes without increasing temperature",
          "Separates ions in solutions",
          "Produces polymeric materials"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: What safety precautions are required when using radioactive isotopes in diagnostics and therapy in medicine?",
        "options": [
          "*Use of low-energy radiation sources",
          "Performing activities for a short time",
          "All of the above",
      ...
      {
        "question": "Situation: Which nuclear reactant is used to irradiate cancer cells?",
        "options": [
  ...
  "t-s-1-9-5": {
    ...
    "situational": [
      {
        "question": "Situation: In acid-base balance, the pH of the blood increased to 7.8. What is this condition called?",
        "options": [
          "*Acidosis",
      ...
      {
        "question": "Situation: The patient needs an infusion solution with a stable pH. Which buffer solution should be chosen?",
        "options": [
      ...
      {
        "question": "Situation: The pH of blood was found to drop to 7.3. Which buffer system will help normalize this condition?",
        "options": [
          "*Ammonia buffer",
          "Carbonate buffer",
          "Phosphate buffer",
      ...
      {
        "question": "Situation: What are the main components of the carbonate buffer?",
        "options": [
          "*H2CO3 and HCO3-",
          "H2SO4 and SO42-",
          "NaOH and NaCl",
      ...
      {
        "question": "Situation: Why are buffer systems important for enzymatic reactions in the body?",
        "options": [
          "*They maintain optimal reaction speed",
          "They decrease metabolic rate",
          "They disrupt chemical equilibrium",
          "They break down biological catalysts"
        ],
        "correctIndex": 0
      }
    ]
  ...
  "t-s-1-9-6": {
    "test": [
      ...
      {
        "question": "If the pH = 3, what type of solution is this?",
        "options": [
          "*Strong acid",
          "Weak acid",
          "Strong base",
    ...
    "situational": [
      {
        "question": "Situation: A doctor recommended chelate compounds to address iron deficiency. What characteristic do these compounds have?",
        "options": [
          "*They stabilize iron ions in solutions",
          "They break down ions",
          "They remove ions",
          "They serve as active catalysts"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: Doctors recommended using EDTA to manage calcium ion concentration. What process is this based on?",
        "options": [
      ...
      {
        "question": "Situation: What is the purpose of using chelate compounds in chronic heavy metal poisoning?",
        "options": [
          "*To remove heavy metals from the body",
          "To restore blood pH balance",
          "To enhance the effect of antibiotics",
          "To normalize electrolyte balance"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: What type of chemical bond forms the structure of internal complex compounds?",
        "options": [
      ...
      {
        "question": "Situation: When is chelation therapy used?",
        "options": [
  ...
  "t-s-1-9-7": {
    "test": [
      ...
      {
        "question": "11. What is a complex compound?",
        "options": [
      ...
      {
        "question": "12. What is the central atom in a complex compound typically made of?",
        "options": [
          "*A metal atom or ion",
          "Hydrogen ion",
          "Neutral molecules",
      ...
      {
        "question": "13. What is the function of EDTA in chelation therapy?",
        "options": [
      ...
      {
        "question": "14. What is the primary advantage of chelation?",
        "options": [
      ...
      {
        "question": "15. What is the primary medical use of chelate complexes?",
        "options": [
      ...
      {
        "question": "16. When is chelation therapy most commonly recommended?",
        "options": [
      ...
      {
        "question": "17. Which ligand has a high chelating capacity?",
        "options": [
      ...
      {
        "question": "18. Which of the following is an example of a chelate complex?",
        "options": [
          "*[Cu(EDTA)]²⁻",
          "NaCl",
          "[Fe(CN)₆]³⁻",
      ...
      {
        "question": "19. Which of the following is an example of a chelating ligand?",
        "options": [
      ...
      {
        "question": "20. Why is chelation therapy used?",
        "options": [
    ...
    "situational": [
      {
        "question": "Situation: A chemical catalyst was added to increase the reaction rate. What is the role of this catalyst?",
        "options": [
          "*It lowers activation energy",
          "It shifts the chemical equilibrium",
          "It decomposes the substrate",
          "It increases temperature"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: How does changing the pH affect catalysis by enzymes?",
        "options": [
          "*Alters the enzyme's activity",
          "Stop the reaction",
      ...
      {
        "question": "Situation: The reaction rate increased with higher temperature. Which factor does this demonstrate?",
        "options": [
          "*Decreased activation energy",
          "Addition of a catalyst",
          "Spatial arrangement of reactants",
          "Increased concentration of reactive molecules"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: What does the Arrhenius equation in chemical kinetics explain?",
        "options": [
          "*The relationship between reaction rate and activation energy",
          "Measuring reaction heat",
          "Calculating ion activity",
          "Osmotic pressure of solutions"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: When the substrate concentration increased in enzymatic reactions, the reaction rate showed a limited increase. What does this indicate?",
        "options": [
          "*Enzymes are operating in a saturated state",
          "Activation energy is increasing",
          "Reactive molecules are decomposing",
          "The catalyst is being depleted"
        ],
        "correctIndex": 0
      }
    ]
  ...
  "t-s-1-9-8": {
    "test": [
      {
        "question": "1. How do inhibitors affect enzymatic catalysis?",
        "options": [
      ...
      {
        "question": "2. How does a catalyst affect the reaction rate?",
        "options": [
      ...
      {
        "question": "3. How does an increase in temperature affect reaction rate?",
        "options": [
      ...
      {
        "question": "5. How does substrate concentration affect enzymatic reactions?",
        "options": [
      ...
      {
        "question": "7. What happens to enzymes at very high temperatures?",
        "options": [
      ...
      {
        "question": "8. What is a common use of enzymes in medicine?",
        "options": [
      ...
      {
        "question": "10. What is an example of an enzymatic reaction in the human body?",
        "options": [
      ...
      {
        "question": "11. What is chemical kinetics?",
        "options": [
      ...
      {
        "question": "12. What is the activation energy of a reaction?",
        "options": [
      ...
      {
        "question": "13. What is the Michaelis-Menten constant (Km)?",
        "options": [
      ...
      {
        "question": "14. What is the primary medical use of enzymatic catalysis?",
        "options": [
      ...
      {
        "question": "15. What is the role of enzymes in enzymatic catalysis?",
        "options": [
      ...
      {
        "question": "16. What is the role of lactase in medicine?",
        "options": [
      ...
      {
        "question": "17. Which enzyme is commonly used in diagnosing liver diseases?",
        "options": [
      ...
      {
        "question": "18. Which factor directly affects the rate of a chemical reaction?",
        "options": [
          "*Temperature",
      ...
      {
        "question": "19. Which factor does not affect enzyme activity?",
        "options": [
          "*Color of the enzyme",
      ...
      {
        "question": "20. Which of the following is a factor that influences reaction rate?",
        "options": [
    ...
    "situational": [
      {
        "question": "Situation: How can the structure of colloidal systems be studied?",
        "options": [
          "*Electron microscopy",
      ...
      {
        "question": "Situation: What is one of the methods for purifying colloidal systems?",
        "options": [
          "*Dialysis",
          "Distillation",
          "Filtration",
      ...
      {
        "question": "Situation: What is the size of particles in a colloid system?",
        "options": [
          "*1-100 nm",
          "1-10 mm",
          "100-1000 nm",
      ...
      {
        "question": "Situation: What type of dispersed system are the proteins in blood plasma classified as?",
        "options": [
          "*Colloid system",
          "Dissolved system",
          "Suspension",
      ...
      {
        "question": "Situation: Which physical phenomenon is used to separate colloid systems?",
        "options": [
          "*Brownian motion",
  ...
  "t-s-1-9-9": {
    "test": [
      ...
      {
        "question": "What are dispersing systems?",
        "options": [
    ...
    "situational": [
      {
        ...
        "options": [
          ...
          "The increase in the concentration of components in the main part relative"
        ],
        "correctIndex": 0
      },
      {
  ...
  "t-s-1-9-10": {
    ...
    "situational": [
      {
        "question": "Situation: How do polyfunctional compounds regulate metabolic processes in the body?",
        "options": [
          "*They modulate enzyme activity",
          "They block brain activity",
          "They increase oxygen flow",
          "They stop energy production"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: What is the main role of polyfunctional compounds in metabolic processes?",
        "options": [
          "*Increases the rate of chemical reactions",
          "Blocks metabolites required for energy production",
          "Activates inactive metabolites",
          "Reduces the formation of secondary metabolites"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: When producing polyfunctional compounds as medicinal agents, which modification is most important?",
        "options": [
          "*Increasing their biological activity",
          "Rapidly incorporating them into metabolism",
          "Transferring them to the final transport site",
          "Making them completely inert"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: Which polyfunctional compound is used as an antibiotic and how does it affect bacterial infections?",
        "options": [
          "*Penicillin",
          "Aspirin",
          "Paracetamol",
      ...
      {
        "question": "Situation: Why are polyfunctional compounds used as medicinal agents in medicine?",
        "options": [
          "*They have multiple biological effects",
          "They are quickly eliminated from the body",
          "They are not toxic",
          "They only affect one system"
        ],
        "correctIndex": 0
      }
    ]
  ...
  "t-s-1-9-11": {
    "test": [
      ...
      {
        "question": "How do multifunctional metabolites affect the central nervous system?",
        "options": [
      ...
      {
        "question": "Which multifunctional compound is known for its role in pain relief and inflammation reduction?",
        "options": [
          "*Aspirin",
          "Glucose",
          "Sodium chloride",
    ...
    "situational": [
      {
        "question": "Situation: As heterofunctional compounds, how does the presence of acidic and basic groups affect them? Выберите один ответ:",
        "options": [
          "*It increases their biological activity",
          "It blocks internal activity",
          "Their activity decreases",
          "They only release excess energy"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: In what forms are heterofunctional compounds used as medicinal agents?",
        "options": [
          "*Mainly as potassium and sodium salts",
          "Chemical modifications are made to activate their activity",
          "They are used only in syringes",
          "They have only one function"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: What are the benefits of using heterofunctional compounds in metabolic processes?",
        "options": [
          "*They create opportunities to produce multiple metabolites",
          "They help only in energy production",
          "They are used only to eliminate toxins",
          "They directly control acid-base reactions"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: What is the most important characteristic when producing heterofunctional compounds as medicinal agents?",
        "options": [
          "*Their biocompatibility",
          "Their rapid degradation",
          "Their oxidation",
          "Their fastest growth"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: What medical activities are associated with heterofunctional compounds?",
        "options": [
          "*They perform multiple biological effects",
          "They only affect one system",
          "They are used only as vitamins",
  ...
  "t-s-1-9-12": {
    "test": [
      ...
      },
      {
        ...
        "options": [
          "*They enhance the specificity and effectiveness of drug interactions",
    ...
    "situational": [
      {
        "question": "Situation: How is aminobenzoic acid used in medicine?",
        "options": [
          "*As an anesthetic",
          "Provides long-lasting effects",
          "Anti-inflammatory",
          "Stops biochemical processes in the brain"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: In which case is salicylic acid effective?",
        "options": [
      ...
      {
        "question": "Situation: What important medicinal use does sulfanilic acid have?",
        "options": [
          "*Used as an antimicrobial drug",
          "Drugs that stimulate liver function",
      ...
      {
        "question": "Situation: What is the main advantage of sulfanilic acid as an antibiotic?",
        "options": [
          "*Works effectively against pathogenic microorganisms",
          "Stops energy production",
          "Has no effect",
          "Quickly causes pus formation"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: What is the medical importance of salicylic acid?",
        "options": [
  ...
  "t-s-1-9-13": {
    "test": [
      ...
      },
      {
        ...
        "options": [
          ...
          "Their disability to dissolve in water",
    ...
    "situational": [
      {
        "question": "Situation: How are condensed heterocyclic compounds used?",
        "options": [
          "*They are converted into therapeutic substances",
          "They only enhance biological activity",
          "They produce energy",
      ...
      {
        "question": "Situation: In which conditions can heterocyclic compounds be used?",
        "options": [
          "*As antidepressants",
          "To induce chronic diseases",
          "Only to strengthen bones",
          "To enhance vision"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: What biochemical processes do neurotransmitters containing heterocyclic rings regulate?",
        "options": [
          "*They help transmit nerve impulses",
          "They make the person feel relaxed",
      ...
      {
        "question": "Situation: What is the medical significance of heterocyclic compounds?",
        "options": [
      ...
      {
        "question": "Situation: What is the role of neurotransmitters containing heterocyclic rings in medicine?",
        "options": [
          "*They are used to modulate the nervous system",
  ...
  "t-s-1-9-14": {
    "test": [
      ...
      {
        "question": "What role do heterocyclic compounds play in the design of neuroactive drugs?",
        "options": [
    ...
    "situational": [
      {
        "question": "Situation: How do amino acids affect the body?",
        "options": [
          "*They regulate protein synthesis",
          "They completely break down proteins",
          "They only serve as an energy source",
          "They only contribute to the body's composition"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: What are the properties of amino acids?",
        "options": [
          "*They affect important biological processes in the body",
          "They inhibit enzymes",
          "They only produce energy",
          "They stop protein synthesis"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: What groups are present in the structure of amino acids?",
        "options": [
          "*Amino and carboxyl groups",
          "Carbonyl and aldehyde groups",
          "Methyl and amino groups",
          "Carboxyl and methyl groups"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: What is the biological significance of amino acids?",
        "options": [
          "*They form proteins",
          "They maintain balance",
          "They only function as neurotransmitters",
          "They only produce energy"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: Which amino acid affects the nervous system and functions as a neurotransmitter?",
        "options": [
          "*Glutamate",
          "Alanine",
          "Glycine",
  ...
  "t-s-1-9-15": {
    ...
    "situational": [
      {
        "question": "Situation: How is one of the qualitative reactions for proteins performed?",
        "options": [
          "*Biuret reaction",
          "Acid-sodium reaction",
          "Hydrogen oxidation",
      ...
      {
        "question": "Situation: What factors affect the properties of proteins?",
        "options": [
      ...
      {
        "question": "Situation: What is the main function of proteins?",
        "options": [
      ...
      {
        "question": "Situation: What is the structure of proteins?",
        "options": [
          "*Composed of a chain of amino acids",
          "Made from only one group of amino acids",
          "Composed of a nucleotide chain",
          "Made from a sugar chain"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: What laboratory method can be used to detect proteins?",
        "options": [
          "*Biuret reaction",
          "Physical indicators",
          "Photon microscopy",
  ...
  "t-s-1-9-16": {
    ...
    "situational": [
      {
        "question": "Situation: What effect does glucose have on disaccharides?",
        "options": [
          "*It forms maltose and sucrose",
          "It does not react with acids",
          "It synthesizes proteins",
          "It only serves as an energy source"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: What is the difference between fructose and glucose?",
        "options": [
          "*Fructose dissolves well in buffered systems",
          "They are only used in metabolism",
          "Their structures are the same, but they are isomers",
          "Fructose is used only in acid reactions"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: What is the main function of sucrose?",
        "options": [
      ...
      {
        "question": "Situation: What is the structure of monosaccharides?",
        "options": [
          "*Composed of one or several carbon atoms",
      ...
      {
        "question": "Situation: What role do monosaccharides play in the body?",
        "options": [
          "*They serve as an energy source",
          "They only assist in fermentation",
          "They affect fat formation",
          "They only synthesize proteins"
        ],
        "correctIndex": 0
      }
    ]
  ...
  "t-s-1-9-17": {
    ...
    "situational": [
      {
        "question": "Situation: What is the biological significance of starch?",
        "options": [
      ...
      {
        "question": "Situation: What is the similarity between glycogen and starch?",
        "options": [
          "*Both are made from glucose",
          "Both are made from lipids",
      ...
      {
        "question": "Situation: What is the structure of heteropolysaccharides?",
        "options": [
          "*Composed of several types of monosaccharides",
          "Made from nucleotide chains",
          "Made from only one type of monosaccharide",
          "Composed only of proteins"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: What is the structure of polysaccharides?",
        "options": [
          "*Composed of many monosaccharide chains",
          "Made of several types of lipid chains",
          "Made from several amino acids",
          "Composed of several nucleotide chains"
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: Where is cellulose found and what role does it play?",
        "options": [
          "*In plants, it provides mechanical support",
          "In animals, it controls the nervous system",
          "It protects against external damage",
          "It dissolves in water and produces energy"
        ],
        "correctIndex": 0
      }
    ]
  ...
  "t-s-1-9-18": {
    "test": [
      ...
      {
        "question": "What medical condition is associated with the disability to digest lactose?",
        "options": [
          "*Lactose intolerance",
          "Osteoporosis",
          "Hypertension",
      ...
      {
        "question": "Which monosaccharide is critical for brain function?",
        "options": [
          "*Glucose",
          "Galactose",
          "Fruits",
    ...
    "situational": [
      {
        "question": "Situation: How are polyphosphate nucleosides applied in medicine?",
        "options": [
          "*As coenzymes.",
      ...
      {
        "question": "Situation: In which biological processes are nucleosides and nucleotides involved?",
        "options": [
      ...
      {
        "question": "Situation: What distinguishes nucleosides from nucleotides?",
        "options": [
          "*Nucleosides lack phosphate groups.",
          "Nucleosides do not contain phosphates.",
          "Nucleotides form nucleic acids.",
          "Nucleodes only provide energy."
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: What is the action of nucleoside cyclophosphates?",
        "options": [
          "*They assist in DNA and RNA synthesis.",
          "They protect from external damage.",
          "They aid in liver detoxification.",
          "They contribute to protein synthesis."
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: What is the role of nucleotides as coenzymes?",
        "options": [
          "*They facilitate energy transfer.",
          "They modify genetic material.",
          "They help in pain reduction.",
          "They contribute to cell structure formation."
        ],
        "correctIndex": 0
      }
    ]
  ...
  "t-s-1-9-19": {
    ...
    "situational": [
      {
        "question": "Situation: How is the ribosome structured and what is its function?",
        "options": [
          "*Composed of RNA and proteins, involved in protein synthesis.",
          "Made solely of DNA.",
          "Only contributes to protein formation.",
          "Only involved in lipid regulation."
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: What are the complementary base pairs in DNA?",
        "options": [
          "*Adenine-Thymine and Guanine-Cytosine.",
          "Adenine-Uracil and Guanine-Cytosine.",
          "Cytosine-Adenine and Thymine-Guanine.",
          "Thymine-Uracil and Guanine-Adenine."
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: What is the function of nucleic acids?",
        "options": [
          "*Storing and transmitting genetic information.",
          "Regulating protein synthesis.",
          "Controlling fat synthesis.",
          "Storing memories."
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: What is the structure of the DNA double helix?",
        "options": [
          "*A two-chain spiral.",
          "Circular in shape.",
      ...
      {
        "question": "Situation: Which RNA type is responsible for protein production?",
        "options": [
          "*Ribosomal RNA.",
          "Transfer RNA.",
          "Messenger RNA.",
  ...
  "t-s-1-9-20": {
    ...
    "situational": [
      {
        "question": "Situation: How are enzymes classified?",
        "options": [
          "*Based on their chemical properties and activity.",
      ...
      {
        "question": "Situation: How does enzyme diagnostics work?",
        "options": [
          "*By detecting diseases via enzyme activity.",
          "Through nucleotide analysis.",
      ...
      {
        "question": "Situation: How does enzyme therapy function?",
        "options": [
          "*It restores the biological activity of enzymes.",
      ...
      {
        "question": "Situation: What does enzyme pathology refer to?",
        "options": [
      ...
      {
        "question": "Situation: What is the primary function of enzymes?",
        "options": [
          "*Accelerating chemical reactions.",
          "Producing energy.",
          "Protecting from toxic substances.",
  ...
  "t-s-1-9-21": {
    ...
    "situational": [
      {
        "question": "Situation: How do water-soluble vitamins function?",
        "options": [
          "*They dissolve in water and are absorbed by the body.",
          "They dissolve in fats and perform functions.",
          "They are used only for genetic diseases.",
          "They have toxic effects."
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: What are the effects of vitamin A deficiency?",
        "options": [
          "*Impaired vision.",
          "Improved metabolism.",
      ...
      {
        "question": "Situation: What are the functions of fat-soluble vitamins?",
        "options": [
          "*They dissolve in fats and are stored in cell membranes.",
          "They solely produce energy.",
          "They dissolve only in liquids.",
          "They dissolve only in the bloodstream."
        ],
        "correctIndex": 0
      },
      {
        "question": "Situation: What is the biological importance of B vitamins?",
        "options": [
          "*They enhance metabolism.",
      ...
      {
        "question": "Situation: What is the primary function of vitamin C?",
        "options": [
          "*Acting as an antioxidant.",
          "Maintaining a healthy lifestyle.",
          "Inhibiting immune system function.",
  ...
  "t-s-1-9-22": {
    ...
    "situational": [
      {
        "question": "Situation: No need to learn this because this topic not contain any questions go ahead",
        "options": [
          "*Option A",
          "Option B",
          "Option C",
