export const s_2_1_situational = {
  "t-s-2-1-0": [
    {
  ...
  "t-s-2-1-5": [
    {
      ...
      "correctIndex": 0,
      "explanation": "Porphyrias are rare inherited or acquired disorders of certain enzymes in the heme biosynthetic pathway, causing accumulation of porphyrin precursors (red urine)."
    },
    {
      ...
      "correctIndex": 0,
      "explanation": "Pathological bilirubinuria (direct bilirubin in urine) typically indicates conjugated hyperbilirubinemia, caused by either liver parenchyma damage (hepatitis) or biliary obstruction."
    },
    {
      ...
      "correctIndex": 0,
      "explanation": "Hemolytic jaundice results from massive RBC destruction, leading to increased indirect bilirubin in blood, and elevated urobilin and stercobilin due to high heme breakdown."
    },
    {
      ...
      "correctIndex": 0,
      "explanation": "Neonatal jaundice is most commonly physiological, caused by a transient immaturity of hepatic UDP-glucuronosyltransferase, leading to elevated indirect (unconjugated) bilirubin."
    },
    {
      ...
      "correctIndex": 0,
      "explanation": "Venomous snake bites can contain hemotoxins that lyse red blood cells, overwhelming the liver and massively increasing indirect (unconjugated) bilirubin in the plasma."
    }
  ],
  "t-s-2-1-6": [
    {
