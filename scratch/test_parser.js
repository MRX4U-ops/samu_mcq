...
for (let i = 1; i <= 15; i++) {
    ...
    console.log(`Topic ${i}: Parsed ${parsed.length} questions`);
    if (parsed.length > 0) {
        console.log(`  Q1: "${parsed[0].question}"`);
        console.log(`  Options (1st correct):`, parsed[0].options);
        console.log(`  QLast: "${parsed[parsed.length - 1].question}"`);
        console.log(`  Options (1st correct):`, parsed[parsed.length - 1].options);
    }
}
